...
## snp.dat
This is an example dataset to show how to use medeas. The data where generated using a coalescence simulation software (scrm). The data was then post-process to match medeas format.
